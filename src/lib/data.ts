...
export const initialRegistrationFields: RegistrationField[] = [
    { id: 'phoneNumber', label: 'Phone Number', type: 'TEXT', enabled: true, required: true },
...
export const roles: Role[] = [
  ...
  },
  {
    ...
    permissions: {
      ...
      products: { c: true, r: true, u: true, d: true },
      courses: { c: true, r: true, u: true, d: true },
      approvals: { c: false, r: true, u: true, d: false },
      learningPaths: { c: true, r: true, u: true, d: true },
      quizzes: { c: true, r: true, u: true, d: true },
      grading: { c: false, r: true, u: true, d: false },
      liveSessions: { c: true, r: true, u: true, d: true },
      reports: { c: false, r: true, u: false, d: false },
      certificate: { c: false, r: true, u: true, d: false },
      settings: { c: true, r: true, u: true, d: true },
    }
  },
  {
